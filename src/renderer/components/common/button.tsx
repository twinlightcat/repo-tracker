...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: "bg-amber-400 text-white hover:bg-amber-500 active:bg-amber-700",
    secondary:
      "border-2 border-amber-400 text-amber-400 bg-transparent hover:bg-amber-50 active:bg-amber-100",
  };
